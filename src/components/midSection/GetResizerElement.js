...
export const getResizer = (attr1, attr2, decoded) => {
  const resizer = document.createElement("span");
    ...
    console.log("mubeen resizer", resizer)
  ...
  //     attr1 === "bottom" && attr2 === "right" ? "nwse-resize" : "nesw-resize";
  // };
  ...
  //       cursor: "pointer",
  //       ...(attr1 === "top" ? { top: "-5px" } : { bottom: "-5px" }),
  //       ...(attr2 === "left" ? { left: "-5px" } : { right: "-5px" }),
  //     }}
  //     className="resizeBtn"
