...
const ShareDocModal = ({
  ...
  const { pendingMail, setPendingMail } = useStateContext();
        ...
        <Container fluid>
          <form className="justify-content-center share-form">
              ...
              <Col>
                <label>
                  ...
                  <input
                    ...
                    className="form-control share-input "
                    value={froName}
                    onChange={(e) => setFroName(e.target.value)}
                  />
                </label>
              </Col>
            </Row>
            ...
            <Row>
              <Col className="w-100">
                <label>
                  ...
                  <input
                    type="text"
                    className="share-input form-control w-full"
                    value={subject}
            ...
            <Row>
              <Col>
                <Button
                  className="remove_button share-btn text-white mt-2"
                  type="button"
                  onClick={handleShare}
                >
                  {pendingMail ? "Sending" : "Share"}
                </Button>
              </Col>
            </Row>
